          ...
          <div className="mt-4 flex flex-col gap-8">
            <div className="min-h-[120px] leading-normal md:min-h-[160px]">
              <h1 className="text-3xl leading-normal font-bold tracking-normal text-foreground md:text-5xl">
                Открытые роли с чёткими задачами и измеримыми результатами.
              </h1>
            </div>
            <p className="text-lg tracking-tight text-muted-foreground">
              Если тебе подходит работа с понятными ожиданиями, фиксированными
              дедлайнами и прямой коммуникацией — смотри роли ниже.
            </p>
            <p>
              Angara Lab управляет и развивает сервисные проекты в
              Лос-Анджелесе: Angara Steamers и Playa Cleaning. Работа в этих
              ролях связана с маркетингом, контентом и операционными задачами,
              которые напрямую влияют на рост и эффективность бизнеса. Каждый
              процесс структурирован, каждое действие имеет понятный результат,
              а каждую неделю есть конкретные обязательные deliverables.
            </p>
            <p>
              Эти роли подходят специалистам, которым комфортно работать в
              понятной системе: есть чёткие задачи, фиксированные дедлайны и
              прозрачные обязательные результаты на каждую неделю. Работа
              строится вокруг конкретных действий, которые дают видимую динамику
              — в показателях, в качестве процессов и в развитии проектов.
            </p>
            <p>
              У нас ценится самостоятельность в рамках роли, аккуратность в
              выполнении задач и умение держать стабильный рабочий ритм. Если
              тебе близок структурированный подход, прямое взаимодействие по
              делу и возможность влиять на развитие проектов через свои
              результаты — переходи к списку ролей.
            </p>
          </div>
